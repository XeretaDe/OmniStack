...
const message = `Hello ${incident.name}, I would like to help in the case "${incident.title}" with a value of ${Intl.NumberFormat('pt-BR', {style: 'currency',currency: 'BRL'}).format(incident.value)}`;
